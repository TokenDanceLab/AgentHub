---
title: AgentHub 产品总览
summary: AgentHub 是 IM 形态的多 Agent 协作工作台，采用 Hub/Edge 双层架构；活进度以 docs/progress/MASTER.md 为准（Phase 69）
tags:
  - overview
  - product
  - hub-edge
...
|---|---|
| 规则 | `AGENTS.md` |
| 活进度 | `docs/progress/MASTER.md`（Phase 69 / milestone 85，2026-07-18） |
