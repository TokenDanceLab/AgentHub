...
- `docs/architecture/system-design/system-architecture.md`：Desktop-Edge-Hub 架构、Agent 产品模型、执行生命周期和职责边界。
- `docs/architecture/system-design/implementation-guide.md`：当前实现顺序、Adapter 细节和验收命令。
