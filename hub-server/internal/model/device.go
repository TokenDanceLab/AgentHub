...
type Device struct {
	...
	UserID       string    `gorm:"type:uuid;not null;index:idx_devices_user_type,unique" json:"user_id"`
	DeviceType   string    `gorm:"type:varchar(16);not null;index:idx_devices_user_type,unique" json:"device_type"`
