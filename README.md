...
<img src="https://img.shields.io/badge/状态-P3_完成-blue?style=flat-square" alt="status">
...
当前已完成：Edge Server 三大 Agent CLI 适配（Claude Code 5/5 E2E 通过，OpenCode/Codex 协议完整），Desktop IM 聊天式交互（Markdown 渲染、语法高亮、流式打字、Tool Call 卡片、Diff 内联、暗/亮主题），Hub Server API 骨架（18 路由就绪）。P0-P3 全部完成，推进 M4 协作能力。详细进展见 [路线图](docs/roadmap.md)。
