...
Assert-Contains "app\web\src\api\hubAuth.test.ts" "getAuthorization\(init\)\)\.toBe\('Bearer web-fixture-access-token'\)" "Web fixture uses Hub-issued Bearer token for target inventory"
