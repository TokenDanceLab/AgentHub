...
def check_required_markers() -> None:
    required = [
        ...
        ("AGENTS.md", ".agents/skills/real-e2e-acceptance/SKILL.md"),
        ("AGENTS.md", "避免巨石文档"),
        ...
        (".agents/skills/real-e2e-acceptance/SKILL.md", "Packaged release"),
        ("api/events.md", "Owner"),
        ...
        ("scripts/release/verify-tauri-package-readiness.ps1", "Assert-WorkflowCommandExplicitOptIn"),
        ("scripts/release/verify-tauri-package-readiness.ps1", "Assert-NoMacOSUnsignedDryReleaseActions"),
