...
try {
    ...
    Start-ServiceProcess -Name 'desktop'     -WorkingDir "$RepoRoot\app\desktop"  -Exe 'pnpm' -Args @('dev')
    ...
    $allReady = (Wait-ForPort -Name 'Desktop' -Port 5173 -HostAddr 'localhost') -and $allReady
