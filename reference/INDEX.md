...
- 三份主文档：[产品需求](../docs/architecture/system-design/product-requirements.md)、[系统架构](../docs/architecture/system-design/system-architecture.md)、[功能实现](../docs/architecture/system-design/implementation-guide.md)
