...
```
想看全貌 → competitive/00-synthesis.md
想看最佳实践 → competitive/10-best-practices-playbook.md
想看多 Agent 聚合/委派/git worktree/IM 通道 → projects/codeg/
想做架构判断/ADR/RAG Memory/权限双轴 → competitive/12-awesome-architecture-study.md
想看产品方向/长期路线 → competitive/14-product-direction-competitive-roadmap.md
想做 UI → projects/multica/ · projects/opencode/ · projects/lobehub/ · projects/cherry-studio/
想做安全 → projects/claude-code-sdk/ · competitive/07-permission-models.md
想做适配器 → competitive/01-adapters.md · projects/aionui/
想做编排 → competitive/03-orchestration.md · competitive/13-agentteam-competitive-roadmap.md · projects/aionui/ · projects/codeg/
想做沙箱 → competitive/04-sandbox-tools.md · projects/aionui/
想做撤销 → competitive/05-undo-rollback.md
想做实时同步 → competitive/06-realtime-sync.md
想做 Prompt → competitive/09-prompt-engineering.md
想做 UI 美化 → competitive/08-ui-beautify-plan.md · projects/aionui/09-ui-deep-comparison.md · projects/cherry-studio/02-ui-and-source-patterns.md
...
想做消息/IM → projects/librechat/ · projects/codeg/ · competitive/02-im-ux.md
想做 worktree/diff → projects/claude-code-viewer/ · projects/codeg/
想做 Team/多Agent → competitive/13-agentteam-competitive-roadmap.md · projects/aionui/ · projects/lobehub/ · projects/codeg/
