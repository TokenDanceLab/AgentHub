...
**AgentHub 特有增强**：
- **Authority 可视化**：每条消息标注产生此消息的 Authority（如 `[Hub]` / `[Edge:edge-01]`），用色带标识
...
│ [All] [Hub] [Edge:edge-01] [MCP]│  ← Authority/Edge 过滤标签
├─────────────────────────────┤
│ TODAY                       │
│ ┌─────────────────────────┐ │
...
│ │ [Hub] [Edge:edge-01]        │ │  ← Authority/Edge badge
│ └─────────────────────────┘ │
│ ┌─────────────────────────┐ │
│ │ 🔧 codex · 已归档       │ │  ← 归档状态
...
│                                                    │
│ ┌─ [Edge:edge-01] Claude · Tool Use: Read ─────────┐  │
│ │  ┌──────────────────────────────────────────┐ │  │
...
│ └──────────────────────────────────────────────┘  │
│                                                    │
│ ┌─ [Edge:edge-01] Claude · Thinking ────────────────┐ │
│ │  (default collapsed, 点击展开)                 │ │
│ └──────────────────────────────────────────────┘  │
│                                                    │
│ ┌─ [Edge:edge-01] Claude · Tool Use: Edit ──────────┐ │
...
消息内部标注 Authority 来源标签 `[Hub]` / `[Edge:edge-01]` / `[Hybrid]`。
...
│ ←→ (拖拽调整分屏比例)                           │
│                                                 │
│ Generated by [Edge:edge-01] Claude · Session #42   │  ← 可追溯性
