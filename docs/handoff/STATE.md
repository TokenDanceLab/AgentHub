...
最后更新：2026-05-29 UTC+8 | 分支：fix/hub-device-uuid-contract -> dev/delicious233 | 状态：后端隔离 worktree完成 Hub 后端/生产 smoke 收口；Desktop/UI 主工作树仅只读确认
