...
│   │   │   ├── AuthorityFilterChips  ([All] [Hub] [Edge:edge-01] [Edge:edge-02] [MCP])
...
│   │   │               ├── AuthorityBadge ([Hub] / [Edge:edge-01] / [Hybrid])
...
│   │   │   ├── ExecutionBadge        ("Edge: edge-01-desktop / Runner #3")
...
│   │   │   │   │   ├── AuthorityLabel ("[Hub]" / "[Edge:edge-01]" / "[Hybrid]")
...
│   │       │   ├── InlineCodeButton
│   │       │   └── FileUploadButton
│   │       ├── ModeIndicator       ("@ClaudeCode on Edge:edge-01" / "Group chat via Hub")
