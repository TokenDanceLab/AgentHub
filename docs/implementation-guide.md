...
| 客户端 | Desktop、Edge 本地调度、Agent Runtime adapter、workspace、preview、远控 Target | `app/desktop/`、`edge-server/` | `docs/client-roadmap.md`、`docs/client-handoff.md`、`api/README.md` |
