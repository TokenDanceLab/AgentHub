...
- `docs/tutorials/quality-convergence.md` — 质量收敛路线图（34 项，11 完成 / 7 部分 / 16 open）
- `docs/archive/worktree-execution-plan.md` — Worktree 执行计划（冲突域拓扑）
- `docs/archive/wave1-progress-review.md` — Wave 1 进度总结
- `docs/tutorials/competitive-gap-*.md` — 4 份竞品分析报告（Chat/UI-UX/工程/产品）
...
详细分析见 `docs/tutorials/competitive-gap-*.md` 四份报告。
