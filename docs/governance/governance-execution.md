...
| TD-P0-DESIGN-01 | Visual QA | `app/desktop/screenshots/`, `app/web/screenshots/`, `app/mobile-rn/screenshots/` | Desktop 14 screenshots (missing approval/error/diff), Web 70+ screenshots (most complete), Mobile RN screenshot QA on 5177; public product sites pending |
