...
| **总进度** | `docs/roadmap.md` + `docs/roadmap/` | 总路线、模块级进度、长期 backlog 和下一步 | Delicious233 |
...
3. **总进度唯一**：长期目标、模块进度和 backlog 写入 `docs/roadmap.md` + `docs/roadmap/`；不要把当前 PR 阻塞、临时验收日志或分支 live 状态长期写进 roadmap。
