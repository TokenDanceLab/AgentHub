...
| Lane | Tasks | Combined Effort | Merge Risk | Key Files |
|:--|:--|:--|:--|:--|
| Prep | T3.0, T3.0b, T3.0c, T3.0d | M+M+S+M | Medium | `api/`, module README files, `hub-server/README.md`, `docs/architecture/`, `docs/governance/`, `docs/progress/MASTER.md`, `docs/roadmap.md`, `scripts/verify-doc-ssot.ps1` |
...
| # | Task | Priority | Effort | Depends On | Lane | S.U.P.E.R | Test Expectation | Memory Impact | Acceptance Criteria |
|:--|:--|:--|:--|:--|:--|:--|:--|:--|:--|
| T4.1 | Run focused acceptance gate bundle | P0 | L | T3.0, T3.0b, T3.0c, T3.0d, T3.1, T3.3, T3.4, T3.5 | A | P, E | Run selected docs/API/frontend/backend/visual/package/perf gates based on touched surfaces | None | Evidence table lists commands, pass/fail, artifact paths, and explicit not-tested boundaries. |
