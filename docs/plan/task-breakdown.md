...
| T2.2 | Compress old ADR bodies into `docs/decisions.md` | P0 | M | T2.1 | S/P/R | Current decisions summary exists; old ADR bodies are in external archive; active references point to `docs/decisions.md` or specific current owner docs. |
...
| T3.2 | Reorganize legacy script tests to `tests/contract/scripts` | P1 | M | T3.1 | P/R | Release-readiness, verifier tests, and fixtures point to the contract path; no active caller depends on the legacy path. |
