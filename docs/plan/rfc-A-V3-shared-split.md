...
- 既有边界门禁：`scripts/verify/verify-shared-boundary.py`、`verify-shared-ui-hubclient.py`、`verify-web-hub-boundary.py`、`verify-mobile-hub-boundary.py`、`verify-shared-rest-contract.py`、`verify-hubclient-ssot.py`
