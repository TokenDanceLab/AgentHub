...
| 2 | Shared Chat Timeline Hardening | https://github.com/TokenDanceLab/AgentHub/milestone/18 | 2 | 2 | 4 |
...
- [ ] Phase 2: Shared Chat Timeline Hardening (2/4 tasks) - [milestone](https://github.com/TokenDanceLab/AgentHub/milestone/18)
...
**Active Task**: T2.3 - Harden card grouping and rounded-stack rules (#384)
...
1. Merge #402, then close #383 manually if GitHub does not auto-close it from the non-default base branch.
2. Start T2.3 (#384) in a separate task worktree after #402 lands.
...
| 2026-06-28 | T2.2 implementation | Tightened optimistic send auto-follow so pending-to-confirmed reconciliation does not steal scrollback; Desktop/Web chat-flow E2E and Visual QA passed with `real_tested=false`; #402 ready to merge. |
