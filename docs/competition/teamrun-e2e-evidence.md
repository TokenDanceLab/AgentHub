...
These scripts only validate or package local evidence files. They do not run
real CLI/model gates, start services, upload artifacts, or make the final video
claim unless `-RequireVideo` is passed with an existing recording.
