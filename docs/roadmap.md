...
| R1 | TeamRun E2E transcript 与证据导出 | opus 设计，haiku/sonnet 按需实现 | Hub/Edge 最小修复、Desktop evidence UI、`docs/competition/*` | `phase-r1/teamrun-e2e` 先验证 Desktop bridge 与证据路径；最终仍以两个真实 Runtime Profile 录屏、截图、日志、事件导出为准 |
