...
| Breakpoint SSOT | `tokens-base.css` 注释声明（`--bp-mobile/--bp-narrow/--bp-medium/--bp-wide/--bp-xwide/--bp-ultra` = 480/760/1024/1440/1920/2560；`--bp-narrow: 760px` 由 `tokens-base.test.ts` 断言）——**仅注释，无 CSS 变量声明，亦无 JS 断点 hook** | 实际 @media 宽度混用 480/420/767/760/720/700/768/390/360 等，无 760–1920 布局策略；JS hook + 区间策略在 #1827 响应式部分，在途 |
