...
| 客户端 | Desktop、Edge 本地调度、Agent Runtime adapter、workspace、preview、远控 Target | `app/desktop/`、`edge-server/` | `docs/tutorials/roadmap.md`、`docs/development/handoffs/STATE.md`、`api/README.md` |
...
- 客户端后续以 `docs/tutorials/roadmap.md` 和 `docs/development/handoffs/STATE.md` 为当前入口；`docs/archive/client-handoff.md` 是历史快照，不作为默认接手指南。
