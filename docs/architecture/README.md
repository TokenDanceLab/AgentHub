...
| [03-runtime-adapters.md](03-runtime-adapters.md) | 全部 7 个 adapter 注册 ID（3 CLI + 2 SDK + Orchestrator + RuntimeManifest）、事件映射合同、PreflightAdapter、权限桥接 | ~109 |
...
| [05-deployment.md](05-deployment.md) | hk2 部署、Docker Compose、Nginx、SSL、环境变量、开发环境 | ~83 |
