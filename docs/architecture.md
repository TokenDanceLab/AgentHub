...
| Shared transcript/UI | shared unit/contract + Desktop/Web Playwright + Visual QA；Visual QA gate 89/100（已收口 2026-07-20）· 视口 16:9 `1440x810` light+dark via `visual-qa-shell.mjs` / `visual:qa:shell`（见 [visual-qa-scorecard](analysis/visual-qa-scorecard.md)） |
