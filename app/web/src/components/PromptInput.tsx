  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.dock}>
        <div className={styles.goalBar} aria-label={t('prompt.activeGoal')}>
          <div className={styles.goalIdentity}>
            <Target size={17} aria-hidden="true" />
            <strong>{t('prompt.activeGoal')}</strong>
            <span>{isStreaming || isStarting ? t('prompt.goalRunning') : t('prompt.goalIdle')}</span>
          </div>
          <div className={styles.goalActions}>
            <button type="button" className={styles.goalBtn} aria-label={t('prompt.editGoal')}>
              <Pencil size={15} />
            </button>
            <button type="button" className={styles.goalBtn} aria-label={t('prompt.pauseGoal')}>
              <PauseCircle size={15} />
            </button>
            <button type="button" className={styles.goalBtn} aria-label={t('prompt.clearGoal')}>
              <Trash2 size={15} />
            </button>
            <button type="button" className={styles.goalBtn} aria-label={t('prompt.openGoal')}>
            ...
            <div className={styles.rightGroup}>
              <div className={styles.metaChain}>
                ...
                <span className={styles.reasoningPill}>
                  ...
                  <strong>{resolvedRoute.model || model || selectedAgentAlias || '5.5'}</strong>
                  <em>{resolvedRoute.reasoningEffort || reasoningEffort || t('prompt.reasoningHigh')}</em>
