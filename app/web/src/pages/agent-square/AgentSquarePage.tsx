...
const styles = `
  ...
  .asr-green {
    color: var(--asr-green);
    background: rgba(29, 155, 103, 0.15);
  }
  ...
  .asr-pill-green {
    border-color: rgba(29, 155, 103, 0.25);
    background: rgba(29, 155, 103, 0.15);
    color: var(--asr-green);
  }
  ...
  .asr-status-dot {
    ...
    box-shadow: 0 0 0 4px rgba(29, 155, 103, 0.2);
  }
  ...
  .asr-drawer-empty {
    ...
    gap: 12px;
    padding: 28px;
    border: 1px dashed rgba(23, 105, 232, 0.3);
    border-radius: 12px;
    background: var(--asr-glass);
    text-align: center;
  }
