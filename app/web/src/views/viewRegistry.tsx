 ...
 *
 * Component registration lives in @/viewRegistryConfig (metadata + map).
...
import { VIEW_REGISTRY as REGISTRY } from '@/viewRegistryConfig';
...
export type { ViewMode, ViewDescriptor, ViewProps, ViewConfig } from '@/viewRegistryConfig';
export { VIEWS, VIEW_LIST, getViewsForSlot, getView, isViewVisible } from '@/viewRegistryConfig';

/** Layout slot derived from config (re-export for convenience). */
export type { ViewSlot as LayoutSlot } from '@/viewRegistryConfig';
