    ...
    translation: {
      ...
      chat: {
        ...
        states: {
          ...
          loadingDescription: "Replaying the thread timeline from Hub.",
          syncErrorTitle: "Messages could not sync",
          syncErrorEyebrow: "Replay recovery",
          syncErrorDescription: "Thread replay is paused. Keep the thread selected and retry once the Hub session is available.",
      ...
      runDetail: {
        ...
        review: {
          ...
          description: "This run is paused at an approval checkpoint. Approve to continue or reject to stop it.",
          approved: "Approval accepted. The run can continue.",
          rejected: "Approval rejected. The run is held for follow-up.",
          decisionApproved: "Approval submitted. Hub marked this checkpoint approved.",
          decisionRejected: "Approval submitted. Hub marked this checkpoint rejected.",
          lockApproved: "Approval approved",
          lockRejected: "Approval rejected",
        ...
        decisionSheet: {
          ...
          approveDescription: "Approve this checkpoint and let the run continue.",
          rejectDescription: "Reject this checkpoint and keep the run stopped for follow-up.",
          confirmApprove: "Approve checkpoint",
          confirmReject: "Reject checkpoint",
      ...
      queue: {
        ...
        runs: {
          ...
          metricActive: "Active",
          metricReview: "Review",
          signalOnline: "Hub run API reachable; returned runs can replay on Mobile.",
          signalPending: "Hub is reachable; run replay route is still recovering.",
          signalOffline: "Hub health is offline; run replay is unavailable.",
          targetHealth: {
            noTarget: "Run route signal: no target route was returned for this Hub session.",
            offline: "Run route signal: Hub health is offline, so replay is unavailable.",
            degraded: "Run route signal: Hub is reachable, but run replay is still recovering.",
            ready: "Run route signal: Hub run API is reachable. Mobile can replay returned runs; target health is not verified here yet.",
            wrongProfile: "Run route signal: Hub rejected this profile or permission path. Switch Agent Profile or account before approving.",
            signedOut: "Run route signal: signed out. Sign in before replaying runs or approvals.",
          },
          ...
          recoveryEyebrowReachable: "Replay recovery",
          recoveryEyebrowOffline: "Target recovery",
          recoveryTitle: "Run replay could not sync",
          recoveryReachable: "Run route is degraded: Hub is reachable, but run replay did not return run JSON. Retry after the API or session contract is ready.",
          recoveryOffline: "Hub health is offline. The last execution state is unavailable, so retry before approving or acting on a run from another device.",
