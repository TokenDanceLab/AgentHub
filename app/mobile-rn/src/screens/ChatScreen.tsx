  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text
          numberOfLines={1}
          style={{ color: tokens.color.inkMuted, fontSize: tokens.type.xs, fontWeight: tokens.type.weight.regular, lineHeight: tokens.type.lineHeight.xs }}
        >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={{ color: tokens.color.accent, fontSize: 13, fontWeight: tokens.type.weight.medium, lineHeight: 17 }}>
          {t.messageTab}
        </Text>
      </View>
      <View
      ...
      >
        ...
        <Text style={{ color: tokens.color.inkMuted, fontSize: 13, fontWeight: tokens.type.weight.regular, lineHeight: 17 }}>
          {t.cloudDocsTab}
        </Text>
      </View>
      <Pressable
        ...
        >
          ...
          >
            ...
            <View style={{ flex: 1, minWidth: 0, gap: tokens.space.xs }}>
              <Text
                numberOfLines={1}
                style={{ color: tokens.color.ink, fontSize: 13, fontWeight: tokens.type.weight.medium, lineHeight: 18 }}
              >
                {activeRun?.title ?? thread?.subtitle ?? t.pinnedWorkflow}
              </Text>
              <Text
                numberOfLines={1}
                style={{ color: tokens.color.inkMuted, fontSize: 12, lineHeight: 16 }}
              >
                {activeRun
...
function Composer({
  ...
  return (
    ...
    >
      ...
      >
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: tokens.space.xs }}>
          <ComposerToolButton accessibilityLabel={t.quickReaction} icon="smile" />
          <ComposerToolButton accessibilityLabel={t.agentPicker} icon="at" />
          <ComposerToolButton accessibilityLabel={t.voiceNote} icon="mic" />
          <ComposerToolButton accessibilityLabel={t.evidenceAttachment} icon="image" />
          <ComposerToolButton accessibilityLabel={t.composerFormat} icon="file" />
        </View>
        <Pressable
        ...
        >
          <AgentHubIcon color={tokens.color.inkMuted} name="plusCircle" size={21} />
        </Pressable>
        <Pressable
...
function ComposerToolButton({
  ...
  return (
    ...
    >
      <AgentHubIcon color={tokens.color.inkMuted} name={icon} size={21} />
    </Pressable>
  );
}
