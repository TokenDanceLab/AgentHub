...
/** Props for icon components — extends SVG props with an optional size shorthand. */
...
/** Brain icon — used for thinking / analyze cards. */
...
/** Document-with-lines icon — used for tool / read cards. */
...
/** Search / magnifying glass icon — used for grep / audit / search cards. */
export const IconSearch = memo((p: IconProps) => (
  <svg {...base(p)}><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /></svg>
))
IconSearch.displayName = 'IconSearch'

/** Generic file icon — fallback for unrecognised file types. */
...
/** Edit / pencil icon — used for write / modify cards. */
...
/** Shield / security icon — used for approval cards and shield-role avatar. */
...
/** Right arrow icon — used for route / dispatch cards. */
...
/** Nested-rectangles icon — used for sub-agent cards. */
...
/** Play triangle icon — used for session / run cards. */
...
/** Chevron-down icon — used for collapsible card toggle indicators. */
export const IconChevronDown = memo((p: IconProps) => (
  <svg {...base(p)}><path d="m6 9 6 6 6-6" /></svg>
))
IconChevronDown.displayName = 'IconChevronDown'

/** Target / bullseye icon — used for deploy cards. */
...
/** Upload arrow icon — used for attachment cards. */
...
/** Bar chart icon — used for context-usage cards. */
...
/** Database cylinder icon — used for .sql file type indicators. */
...
/** Curly braces icon — used for .ts/.tsx/.js/.jsx/.json file type indicators. */
...
/** Markdown icon — used for .md file type indicators. */
...
/** CSS / stylesheet icon — used for .css file type indicators. */
...
/** Terminal / CLI icon — used for eslint / prettier / tsc / lint / test tool cards. */
...
/** Git branch icon — used for orchestrator DAG cards. */
