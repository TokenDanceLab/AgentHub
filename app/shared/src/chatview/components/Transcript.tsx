...
export default function Transcript({ items, chatMode, onAgentClick, onBlockContextMenu, onBlockSelect, onBlockAction, onReviewFile, selectedBlockIds, selectionMode, softHiddenBlockIds, actionedBlockIds }: Props) {
  return (
