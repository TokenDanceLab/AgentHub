...
export const chatviewResources = {
  zh: {
    ...
    'card.approval.viewAllChanges': '查看全部变更',
    'card.approval.viewAllChangesAria': '查看本次运行的全部变更（{{count}} 个文件）',
    ...
    'runReview.title': '运行变更审查',
    'runReview.close': '关闭运行变更审查',
    'runReview.summary': '{{count}} 个文件 · +{{additions}} −{{deletions}}',
    'runReview.readOnlyNotice': '聚合审查为只读：如需写回工作区，请在文件预览中使用交互式 Diff（仅桌面本地 Edge 支持）。',
    'runReview.runTitle': '本次运行的全部变更',
  ...
  en: {
    ...
    // #1967: run-level aggregate review entry (approval summary strip + overlay).
    'card.approval.viewAllChanges': 'Review all changes',
    'card.approval.viewAllChangesAria': 'Review all changes of this run ({{count}} files)',
    ...
    // #1967: run-level aggregate review overlay (RunReviewOverlay + DiffReviewPanel runLevel).
    'runReview.title': 'Run change review',
    'runReview.close': 'Close run change review',
    'runReview.summary': '{{count}} files · +{{additions}} −{{deletions}}',
    'runReview.readOnlyNotice': 'Aggregate review is read-only: to write changes back, use the interactive diff in file preview (Desktop Local Edge only).',
    'runReview.runTitle': 'All changes in this run',
