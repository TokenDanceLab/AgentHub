...
export const chatviewResources = {
  zh: {
    ...
    'runReview.readOnlyNotice': '此处仅供查看，不会应用、批准或驳回任何工作区变更。当前记录缺少可信的运行工作目录，禁止用编辑器当前目录猜测历史运行目录。',
  ...
  en: {
    ...
    'runReview.readOnlyNotice': 'This view is inspection-only and cannot apply, accept, or reject workspace changes. The record has no trusted run work directory, so the current editor directory must not be guessed for a historical run.',
