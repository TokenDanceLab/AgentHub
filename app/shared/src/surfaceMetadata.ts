...
export const SURFACE_METADATA = [
  ...
  },
  {
    ...
    descriptionKey: 'surface.web.workbench.description',
    webRoutePattern: '/',
    defaultStatus: 'error',
  },
  {
    ...
    platform: 'web',
    category: 'catalog',
    labelKey: 'nav.agentSquare',
    descriptionKey: 'surface.web.agentSquare.description',
    webRoutePattern: '/agent-square',
    defaultStatus: 'catalogFallback',
  },
  {
    id: 'web.privateChats',
    platform: 'web',
    category: 'communication',
    labelKey: 'nav.privateChats',
    descriptionKey: 'surface.web.privateChats.description',
    webRoutePattern: '/chats',
    defaultStatus: 'loginLocked',
  },
  {
    ...
    descriptionKey: 'surface.web.groupWorkspace.description',
    webRoutePattern: '/group/:id',
  ...
  },
  {
    ...
    platform: 'web',
    category: 'preview',
    labelKey: 'nav.projectPreview',
    descriptionKey: 'surface.web.projectPreview.description',
