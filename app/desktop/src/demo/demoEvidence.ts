...
const builderEvidence: RuntimeEvidenceSnapshot = {
  ...
  previews: [
    { id: 'p1', runId: 'run-builder-1', threadId: 'builder', url: 'https://example.com/preview/builder', status: 'ready', createdAt: '2026-06-10T14:49:00Z' },
  ],
};
...
const teamRunEvidence: RuntimeEvidenceSnapshot = {
  ...
  previews: [
    { id: 'tp1', runId: 'run-teamrun-1', threadId: 'bytedance-teamrun', url: 'https://example.com/preview/teamrun', status: 'ready', createdAt: '2026-06-10T10:11:00Z' },
  ],
};
...
const deployerEvidence: RuntimeEvidenceSnapshot = {
  ...
  previews: [
    { id: 'dp1', runId: 'run-deployer-1', threadId: 'deployer', url: 'https://example.com/preview/deployer', status: 'ready', createdAt: '2026-06-10T14:48:00Z' },
  ],
};
...
const projectAiEvidence: RuntimeEvidenceSnapshot = {
  ...
  previews: [
    { id: 'aip1', runId: 'run-project-ai-1', threadId: 'project-ai', url: 'https://example.com/preview/game-demo', status: 'ready', createdAt: '2026-06-04T18:00:00Z' },
  ],
};
