...
export function formatAttachmentContext(attachments: PromptAttachment[]): string {
...
export function shouldPreviewBrowserFile(file: File): boolean {
...
export async function browserFilesToAttachments(files: File[]): Promise<PromptAttachment[]> {
