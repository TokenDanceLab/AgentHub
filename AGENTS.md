...
| Claude CLI | **opus** = GLM-5.1 | 200k | 强代码和 agentic 能力 | 窄范围代码实现、测试修复、Go/TS 小切片、明确文件集的重构 |
...
- **Claude sonnet**：DeepSeek-V4-Pro，1M 上下文，用于长文本、找东西、简单文档、架构整理和大范围归纳。
- **Claude opus**：GLM-5.1，200k 上下文，用于明确路径内的代码实现和 focused tests；每次只给必要文件。
